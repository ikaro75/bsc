...
public class Controlador extends HttpServlet implements HttpSessionListener {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (cmd == null) {
                ...
                if (cmd.equals("testconnection")) {
                    ...
                    if (sNextAction.equals("")) {
                        ...
                        String sUsuario = cx.getLogin(request.getParameter("email"), request.getParameter("password"));

                        if (sUsuario!=null && !sUsuario.equals("")) {
                            usuario.setCx(cx);
                            usuario.setConfiguracion(sesion.getConfiguracion());
                            usuario.setClave(sUsuario);
                            ...
                            if (request.getParameter("$app") == null) {
                                ...
                                if (request.getParameter("url") != null) {
                                    ...
                                    response.setHeader("Location", "/bsc/vista.jsp");
                                    response.setContentType("text/html");
                                    response.sendRedirect("/bsc/vista.jsp");
                                    return;
                                ...
                                sNextAction="<mensaje><![CDATA[Usuario validado]]></mensaje>";
                                response.setStatus(HttpServletResponse.SC_MOVED_TEMPORARILY);
                                    response.setHeader("Location", "/bsc/interfaz.jsp");
                                    response.setContentType("text/html");
                                    response.sendRedirect("/bsc/interfaz.jsp");
                                ...
                                sNextAction="<mensaje><![CDATA[Usuario validado]]></mensaje>";
                                request.getRequestDispatcher("/mobile/vista.html").forward(request, response);
                            }
                            ...
                            if (!request.getParameter("$app").equals("mobile"))
                                request.getRequestDispatcher("/login.jsp").forward(request, response);
                        }
                    }
                    ...
                    if (sNextAction.equals("")) {
                        ...
                        if (p.equals("")) {
                            ...
                            try {
                                ...
                                userMail.sendEmail("Administrador_del_sistema",
                    ...
                    if (request.getSession().getAttribute("usuario") == null) {
                        ...
                        } else if (cmd.equals("download")) {/* generacion de archivos en excel */
            ...
            if (!cmd.equals("testconnection") && !request.getParameter("$app").equals("mobile"))
                request.getRequestDispatcher("/login.jsp").forward(request, response);
