...
public class Nota  extends Consulta {
     ...
     */
    public Nota(Integer claveNota, Integer claveForma, String claveRegistro, String claveEmpleado, String titulo, String mensaje, String fechaNota, String foto, String nombre) {
        this.claveNota = claveNota;
        this.claveForma = claveForma;
        this.claveRegistro = claveRegistro;
        this.claveEmpleado = claveEmpleado;
    ...
    public Nota(Consulta c) throws Fallo {
        ...
        try {
            ...
            if (c.getCampos().get("clave_registro").getValor() != null && !c.getAccion().equals("delete")) {
                this.claveRegistro = c.getCampos().get("clave_registro").getValor();
            } else {
            ...
            if (c.getCampos().get("clave_empleado").getValor() != null && !c.getAccion().equals("delete")) {
                this.claveEmpleado = c.getCampos().get("clave_empleado").getValor();
            } else {
        ...
        try {
            ...
            if (this.claveForma== 101 && propaga) {
                ...
                while (rs.next()) {
                     ...
                     this.claveRegistro = rs.getString("clave_actividad");
                     q.append(super.insert(true));
                     
                     c.setClave(rs.getString("clave_empleado_asignado"));
                ...
                if (!destinatario.getClave().equals(this.claveEmpleado)) {
                    if (destinatario.getEmail()!=null) {
                        mail.sendEmail("noresponder@fide.org.mx", destinatario.getEmail(),
