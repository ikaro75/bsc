    ...
    public String getAppMenu(Integer appPadre, Integer appActual) {
        ...
        try {                     
            for (Aplicacion aplicacion: aplicaciones) {
                ...
                if (aplicacion.getClaveAplicacionPadre()==appPadre){
                    html.append("<li ");
                    ...
                    html.append("<a href='interfaz.jsp?app=").append(aplicacion.getClaveAplicacion()).append("'>").append(aplicacion.getAplicacion()).append("</a>");
