...
<%  response.setContentType("application/pdf");
    ...
    try {
        ...
        File archivoReporte = new File("C:\\administrax\\reportes\\".concat(reporte.getJrxml()).concat(".jasper"));

        if (!archivoReporte.exists()) {
            debug.append("<debug>El archivo ").append("C:\\administrax\\reportes\\").append(reporte.getJrxml()).append(".jasper").append(" no se encuentra</debug>");
        }
