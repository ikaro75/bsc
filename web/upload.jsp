        ...
        for (int i = 0; i < requestFields.size(); i++) {
            ...
            if (fiField.getName() != null && !fiField.getName().equals("")) {
                ...
                try {
                    ...
                    archivo = new File("c:\\administrax\\".concat(String.valueOf(user.getClave())).concat("\\").concat(archivo.getName()));
			    ...
			    FileChannel origen = new FileInputStream(archivo).getChannel();
                    ...
                    requestParameters.put(fiField.getFieldName(),"/administrax/temp/".concat(user.getClave().toString()).concat("/").concat(Utilerias.decodeURIComponent(fileName)));
