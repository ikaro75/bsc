...
//response.setContentType("text/xml"); 
    ...
    try {
        ...
        cuestionarioActual.setSQL(633, "select", String.valueOf(pk), w);
        
        if  (cuestionarioActual.getClavePunto()!=0) {
            consulta = new Consulta(608,"select",cuestionarioActual.getClavePunto().toString(),"clave_punto=".concat(cuestionarioActual.getClavePunto().toString()), user);
         ...
         if (cuestionarioActual.getClaveBeneficiario()!=0) {
            consulta = new Consulta(613,"select",cuestionarioActual.getClaveBeneficiario().toString(),"clave_beneficiario=".concat(cuestionarioActual.getClaveBeneficiario().toString()), user);
        ...
        frmRespuestaParticipante = new Forma(new Consulta(634, "update", "0", "", user), false);
