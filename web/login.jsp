...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" href="css/sunny/jquery-ui.css"  rel="stylesheet"/>
        ...
        <title>Sistema de Cuadro de Mando Integral / Iniciar sesi&oacute;n</title>
        <style>
                ...
                <td>
                    ...
                    <div align="center">
                        <table style="width:600px">
                            <tr>
                                <td><%if (sesion!=null) { %><img src="<%=((LinkedHashMap) sesion.getConfiguracion().getParametros().get(sesion.getConfiguracion().getParametros().keySet().toString().replace("[", "").replace("]", "").split(",")[0])).get("enterprise_login_logo").toString()%>" style="width:250px; height:auto; margin-left: 150px;margin-bottom: 50px;" /><%}%></td>
                        ...
                        <div id="divLogin">
                            <form action="control?$cmd=login" method="post" name="frmLogin" id="frmLogin">
                                <table width="75%" border="0" align="center" cellpadding="5" cellspacing="0">
                                    ...
                                    <tr>
                                        <td><div align="right" class="etiqueta_forma" >Empresa</div></td>
